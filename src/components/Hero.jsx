  ...
  return (
    <div className="relative h-screen flex items-end pb-20 overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/photos/photo2.jpg')" }}
      />
      {/* Gradient overlay */}
      <div
        className="absolute inset-0"
        style={{ background: 'linear-gradient(to top, #0a0a0a 8%, rgba(10,10,10,0.35) 55%, transparent 100%)' }}
      />
      ...
      <div className="relative z-10 px-12 max-w-2xl">
        <motion.div
          ...
          className="text-xs tracking-[4px] text-[#f5c518] uppercase mb-3"
        >
        ...
        <motion.p
          ...
          className="text-gray-300 text-lg leading-relaxed mb-7 max-w-lg"
        >
